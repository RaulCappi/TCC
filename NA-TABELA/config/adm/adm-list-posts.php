            ...
            <ul class="nav nav-pills mb-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#" class="dropdown-item">Postagens</a>
                        </li>
                        <li>
                        ...
                        <table class='table table-striped table-bordered' style="font-size: 12px;">
                            ...
                            <tbody>
                                ...
                                foreach ($result as $linha) {
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo $pub_codigo; ?></td>
                                        <td><?php echo $pub_titulo; ?></td>
                                        <td><?php echo $pub_descricao; ?></td>
                                        <td><?php echo $pub_conteudo; ?></td>
                                        <td><?php echo $created; ?></td>
                                        <td><?php echo $hora; ?></td>
                                        <td><?php echo $modified; ?></td>
                                        <td><?php echo $hora_modif; ?></td>
                                        <td><?php echo $Usuario_usu_codigo; ?></td>
                                        <?php
                                        ...
                                        <td class="text-center">
                                            <a href="./adm-pub-view.php?id=<?php echo $pub_codigo; ?>"
                                                class='btn btn-outline-primary btn-sm'>Visualizar</a>

                                            <a href="../adm-pub-edit.php?id=<?php echo $pub_codigo; ?>"

...
<head>
    ...
    <link rel="stylesheet" href="/na-tabela/css/styleindex.css">
...
<body style="background-color: black;">
    ...
    <nav class="navbar">
        ...
        <div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="menu-lateral">
            ...
            <div class="offcanvas-body d-flex flex-column">
                ...
                <a href="/na-tabela/paginas/treino-view.php" class="btn"><i class="bi bi-calendar4-week"></i> Treinos</a><br>
                <a href="/na-tabela/paginas/time-view.php" class="btn"><i class="bi bi-file-person"></i> Equipe</a><br>
                <a href="/na-tabela/paginas/sobre.php" class="btn"><i class="bi bi-info-square"></i> Sobre o projeto</a><br>
                 <?php
        ...
        <div>
            <h2 class="montserrat d-none d-md-block" style="color: white; margin-right: 12rem;">VISUALIZAR PUBLICAÇÃO</h2>
        </div>
    ...
    if (!isset($_SESSION['adm_codigo'])) {
        ...
        if (!empty($id)) {
            ...
            echo "<a style='text-decoration: none; color: white;' href='./adm-usu-view.php?id=" . $Usuario_usu_codigo . "'>
            <h3><img class='imagem-perfil rounded-pill' src='/na-tabela/upload/perfil/" . $fotoAutor . "' alt=''> " . $nomeAutor . "</h3>
            </a>";
            ...
            if ($pub_conteudo !== null) {
                echo "<img class='imagem d-block' style='margin: 0 auto; border-radius: 20px;' src='/na-tabela/upload/posts/" . $pub_conteudo . "' alt='Arquivo da publicacao'><br>";
            }
            ...
            <a href='../pub-edit.php?id=" . $pub_codigo . "' style='text-decoration: none; color: white;'>
            <button class='btn rounded-pill m-2' title='Editar publicação'><i class='bi bi-pencil-square'></i> Editar Publicação</button>
            </a>

            <a href='javascript:void(0);' onclick='admconfirmaExclusaoPub(" . $pub_codigo . ")'>

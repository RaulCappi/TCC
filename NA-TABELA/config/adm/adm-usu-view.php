...
<head>
    ...
    <link rel="icon" href="/na-tabela/img/favicon.ico" type="image/x-icon">
...
<body
    style="background-image: url('/na-tabela/img/basketball-black-3840x2160-17410.jpg'); width: 100%; height: 100%; background-size: cover; ">
    <nav class="navbar">
        ...
        <div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="menu-lateral">
            ...
            <div class="offcanvas-body d-flex flex-column">
                ...
                <a href="/na-tabela/config/pub-create.php">
    ...
    <div class="fora container">
        ...
        <div style='border-radius: 20px; overflow-wrap: break-word;' class='position-item col-md-12 bg-dark justify-content-center text-light p-3 m-2'>";
                ...
                if (!empty($id)) {
                    ...
                    if ($usu_foto == null) {
                        echo '<img class="imagem d-block" style="margin: 0 auto; border-radius: 20px;" src="/na-tabela/upload/perfil/padrao.jpg" alt="Foto de perfil">';
                    } else {
                        echo '<img class="imagem-sobre d-block" style="margin: 0 auto; border-radius: 20px;" src="/na-tabela/upload/perfil/' . $usu_foto . '" alt="Foto de perfil">';
                    }
                    ...
                    if (isset($_SESSION['adm_codigo'])) {
                        echo "
                                    ...
                                    <a href='./adm-usu-edit.php?id=" . $usu_codigo . "' style='text-decoration: none; color: white;'>
